        ...
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                    <div class="media align-items-center">
                        <img src="{{ asset('/backend') }}/assets/images/avatars/avatar-13.png" alt="user avatar" class="customer-img rounded-circle">
                        <div class="media-body ml-3">
                ...
                <li class="list-group-item">
                    <div class="media align-items-center">
                        <img src="{{ asset('/backend') }}/assets/images/avatars/avatar-15.png" alt="user avatar" class="customer-img rounded-circle">
                        <div class="media-body ml-3">
                ...
                <li class="list-group-item">
                    <div class="media align-items-center">
                        <img src="{{ asset('/backend') }}/assets/images/avatars/avatar-14.png" alt="user avatar" class="customer-img rounded-circle">
                        <div class="media-body ml-3">
                ...
                <li class="list-group-item">
                    <div class="media align-items-center">
                        <img src="{{ asset('/backend') }}/assets/images/avatars/avatar-16.png" alt="user avatar" class="customer-img rounded-circle">
                        <div class="media-body ml-3">
                ...
                <li class="list-group-item">
                    <div class="media align-items-center">
                        <img src="{{ asset('/backend') }}/assets/images/avatars/avatar-17.png" alt="user avatar" class="customer-img rounded-circle">
                        <div class="media-body ml-3">
