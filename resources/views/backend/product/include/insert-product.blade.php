                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="ckeditor" id="editor1" name="product_short_description" cols="100" rows="10">Enter Your Short Description</textarea>
                                </div>

                                <div class="form-group">
                                    <label>Long Description</label>
                                    <textarea class="ckeditor" id="editor2" name="prodcut_long_description" cols="100" rows="10">Enter Your Long Description</textarea>
                                </div>
